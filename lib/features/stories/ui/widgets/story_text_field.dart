...
class StoryTextField extends StatefulWidget {
  ...
  const StoryTextField({super.key, required this.userData, required this.story, required this.resumeStory, required this.pauseStory});
    ...
    if (state is SendMessageToFriendSuccess) {
      if (!isMuted()) {
        notificationsCubit.sendNotification(
          fCMToken: widget.userData.fCMToken ?? '',
